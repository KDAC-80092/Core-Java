...
public class Program02 {
	...
	public static int menu() {
		...
		System.out.println("9.Object in File.");
		System.out.println("10.Load Object.");
...
//						System.out.println("Size is: " + list.size());
			...
			case 9:
				...
				try(FileOutputStream fout = new FileOutputStream("BookObject.bin"))
				{
					try(ObjectOutputStream oout = new ObjectOutputStream(fout))
					{
//						for(Book b1 : list)
//							oout.writeObject(b1);  //UpCasting
			...
			case 10:
				...
				try(FileInputStream fin = new FileInputStream("BookObject.bin"))
				{
					try (ObjectInputStream oin = new ObjectInputStream(fin))
					{
//						while(true) {
//							Book bk = (Book) oin.readObject();		//DownCasting
